...
service.AddScoped(typeof(IRepositoryAsync<>), typeof(EntitiesRepositories<>));// таким образом сами сервисы смогут подставлять нужные нам типы данных в репозиторрий 
